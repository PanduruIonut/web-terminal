 ...
 *
 * public/cv.txt carries no "generated" header of its own: it is served
 * verbatim to anyone running `curl ionut.codes`, and a build note is noise in
 * someone's terminal. Editing that file by hand is still pointless — the next
 * build overwrites it — which the README says instead.
 */
