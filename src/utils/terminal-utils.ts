...
// One line names this interval out loud ("Five minutes of nothing"), so if you
// change it, change that line too.
...
const idleLines = [
    ...
    "Five minutes of nothing. That is a kind of dedication.",
